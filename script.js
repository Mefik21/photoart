...
/* harmony import */ var _modules_helpersFunction__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/helpersFunction */ "./src/js/modules/helpersFunction.js");
...
/* harmony import */ var _modules_promo__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/promo */ "./src/js/modules/promo.js");
/* harmony import */ var _modules_accroding__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/accroding */ "./src/js/modules/accroding.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slider_js__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', '', '.main-next-btn', '.main-prev-btn');
  Object(_modules_slider_js__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'vertical');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["form"])();
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="phone"]');
  Object(_modules_helpersFunction__WEBPACK_IMPORTED_MODULE_4__["checkTextInput"])('[name=name]');
  Object(_modules_helpersFunction__WEBPACK_IMPORTED_MODULE_4__["checkTextInput"])('[name=message]');
  Object(_modules_styles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '.styles .row');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])('#size', '#material', '#options', 'input.promocode', '.calc-price');
  Object(_modules_filter__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_modules_promo__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-wrapper');
  Object(_modules_accroding__WEBPACK_IMPORTED_MODULE_9__["default"])('.accordion-heading');
...
/* harmony default export */ __webpack_exports__["default"] = (according);
...
function filter() {
  var menu = document.querySelector('.portfolio-menu'),
      ...
      itemsBlock = document.querySelectorAll('.portfolio-block'),
  ...
  items.forEach(function (item) {
    item.addEventListener('click', function () {
      ...
      itemsBlock.forEach(function (block) {
        if (block.classList.contains(_this.getAttribute('data-portfolio'))) {
      ...
      if (no.classList.contains(this.getAttribute('data-portfolio'))) {
...
function form() {
  ...
  var path = {
    // design: 'https://jsonplaceholder.typicode.com/posts',
  ...
  forms.forEach(function (formItem) {
    formItem.addEventListener('submit', function (event) {
      ...
      var api;
      formItem.closest('.popup-design') || formItem.classList.contains('calc_form') ? api = path.design : api = path.question;
      console.log(api);
...
/***/ "./src/js/modules/helpersFunction.js":
/*!*******************************************!*\
  !*** ./src/js/modules/helpersFunction.js ***!
  \*******************************************/
/*! exports provided: postData, checkNumInput, setZero, checkTextInput, getData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "postData", function() { return postData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkNumInput", function() { return checkNumInput; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setZero", function() { return setZero; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkTextInput", function() { return checkTextInput; });
...
function checkNumInput(selector) {
  var numInput = document.querySelectorAll(selector);
  var errorMessage = document.createElement('span');
  errorMessage.style.color = 'red';
  errorMessage.textContent = 'Вводите пожалйста только цифры';
  numInput.forEach(function (item) {
    item.addEventListener('input', function () {
      if (item.value.match(/\D/)) {
        item.style.border = '1px solid red';
        item.insertAdjacentElement('beforebegin', errorMessage);
      } else {
        item.style.border = '';
        errorMessage.remove();
      }
...
/*!**********************************!*\
  !*** ./src/js/modules/modals.js ***!
  \**********************************/
/*! exports provided: showModal, hideModal, modals */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var modalTimerId = setTimeout(function () {
  showModal('.popup-consultation', modalTimerId);
}, 30000);

function showModal(modal, modalTimerId) {
...
function modals() {
  ...
  function modalInteraction(openModalBtn, closeModalBtn, modal, modalTimerId) {
    var modalWindowTrigger = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
    ...
    var openBtns = document.querySelectorAll(openModalBtn),
        closeBtns = document.querySelectorAll(closeModalBtn),
    ...
    modalWindow.addEventListener('click', function (e) {
      if (e.target === modalWindow && modalWindowTrigger) {
        windows.forEach(function (item) {
          item.style.display = '';
        });
        hideModal(modalWindow);
  ...
  modalInteraction('.button-design', '.popup-design .popup-close', '.popup-design', modalTimerId);
  modalInteraction('.button-consultation', '.popup-consultation .popup-close', '.popup-consultation', modalTimerId);
  modalInteraction('.fixed-gift', '.popup-gift .popup-close', '.popup-gift', modalTimerId, true, true);
}
...
function promo(containerSelector) {
  var container = document.querySelector(containerSelector),
      blockImages = container.querySelectorAll('.sizes-block'),
      images = container.querySelectorAll('img'),
      sizeText = container.querySelectorAll('.size'),
      startPrice = container.querySelectorAll('.starting-price'),
      finalPrice = container.querySelectorAll('.final-price');
  blockImages.forEach(function (block, id) {
    block.addEventListener('mouseenter', function (e) {
      var target = e.target;
      images.forEach(function () {
        if (target === block) {
          images[id].setAttribute('src', "assets/img/sizes-".concat(id + 1, "-1.png"));
          sizeText[id].style.display = 'none';
          startPrice[id].style.display = 'none';
          finalPrice[id].style.display = 'none';
        }
      });
    });
    block.addEventListener('mouseleave', function (e) {
      ...
      images.forEach(function () {
        if (target === block) {
          images[id].setAttribute('src', "assets/img/sizes-".concat(id + 1, ".png"));
          sizeText[id].style.display = 'block';
          startPrice[id].style.display = 'block';
          finalPrice[id].style.display = 'block';
        }
      });
    });
  });
...
function slider(slides, dir, next, prev) {
  var slideId = 1,
      pause = false;
  ...
  function showSlides(n) {
    ...
    slideItems[slideId - 1].style.display = 'block';
  }
  ...
  try {
    ...
    prevBtn.addEventListener('click', function () {
      changeSlide(-1);
      slideItems[slideId - 1].classList.remove('slideInLeft');
      slideItems[slideId - 1].classList.add('slideInRight');
    });
    nextBtn.addEventListener('click', function () {
      changeSlide(1);
      slideItems[slideId - 1].classList.remove('slideInRight');
      slideItems[slideId - 1].classList.add('slideInLeft');
    });
  } catch (e) {}
  ...
  function activateAnimation() {
    if (dir === 'vertical') {
      pause = setInterval(function () {
        changeSlide(1);
        slideItems[slideId - 1].classList.add('slideInDown');
      }, 3000);
    } else {
      pause = setInterval(function () {
        changeSlide(1);
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _helpersFunction__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpersFunction */ "./src/js/modules/helpersFunction.js");





function styles(trigger, container) {
  var btn = document.querySelector(trigger),
      stylesContainer = document.querySelector(container);
  ...
  function createCards(response) {
    response.forEach(function (_ref) {
      var src = _ref.src,
          ...
          link = _ref.link;
      var div = document.createElement('div');
      div.classList.add('col-sm-3', 'col-sm-offset-0', 'col-xs-10', 'col-xs-offset-1', 'animated', 'fadeIn');
  ...
  btn.addEventListener('click', function () {
    Object(_helpersFunction__WEBPACK_IMPORTED_MODULE_3__["getData"])('http://localhost:3000/styles').then(function (data) {
      console.log(data);
      createCards(data);
